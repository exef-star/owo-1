...
> 这个表情包仓库是基于Liushen的表情包仓库改版的，原仓库地址：[https://github.com/willow-god/owo/](https://github.com/willow-god/owo/)
> 更多表情包可以查看[https://emotion.xiaokang.me/#/](https://emotion.xiaokang.me/#/)
...
```
https://fastly.jsdelivr.net/gh/exef-star/owo-1/owo-hanta.json
```
